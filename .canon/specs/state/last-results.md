...
When a **same-tree result** reuses a pass or fail, the corresponding status-specific file is refreshed.
...
- `responseTimestamp` is required and uses ISO 8601 format. It records when `response` was produced.
