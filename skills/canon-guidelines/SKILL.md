...
- After drafting findings, spawn a subagent with no inherited conversation context to re-check those findings against these guidelines using this exact prompt template:
  ```
