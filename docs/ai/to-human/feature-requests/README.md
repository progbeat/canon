...
Requests for human-owned canon changes or canon/tooling features that would
help agents work correctly.

- `evaluator-stalls-and-log-gaps.md`: add stronger evaluator-result validation
