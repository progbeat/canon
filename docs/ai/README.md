...
Compact notes for AI agents and human review. Keep this tree small: no raw
logs, long transcripts, duplicate reports, or stale complaints.
...
- `to-human/feature-requests/`: requests for human-owned canon changes or
  canon/tooling features that would help agents work correctly.
