...
pub(crate) const EVALUATOR_BASE_INSTRUCTIONS: &str =
    "You are a read-only evaluator. Answer the current turn using only the developerInstructions payload, current turn input, and project files the tool lets you read.";
